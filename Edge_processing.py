...
def diag_LR_edge_processing(numpydata, edges_diag_LR, singular_RGB_trigger, RGB_tolerance, height_threshold):
                ...
                if width == height:
                    ...
                    if not different_colour:
                        ...
                        if height == 1:
                            ...
                            skip_next = True
                            for xy_adj in void_buffer_adjustments:
                                void_point = [mid_x + xy_adj, mid_y + xy_adj]
                                void_buffer_diag_LR.append(void_point)
                            continue
    ...
    return reduced_diag_LR_edges, remaining_diag_LR_edges, void_buffer_diag_LR
...
def diag_RL_edge_processing(numpydata, edges_diag_RL, singular_RGB_trigger, RGB_tolerance, height_threshold):
                ...
                if -1 * delta_x == height:
                    ...
                    if not different_colour:
                        ...
                        if height == 1:
                            ...
                            for xy_adj in void_buffer_adjustments:
                                void_point = [mid_x - xy_adj, mid_y + xy_adj]
                                void_buffer_diag_RL.append(void_point)
                            continue
    ...
    return reduced_diag_RL_edges, remaining_diag_RL_edges, void_buffer_diag_RL
