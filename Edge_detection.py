...
def image_edge_detection(image_as_numpyarray, RGB_tolerance = 120, singular_RGB_trigger = 50, delta_trigger = 50, block_size = 6):
    ...
    for y in range(img_height):
        ...
        for x in range(img_width):
            ...
            if different_colour:
                ...
                #        returned_edges = edge_variance(pending_edges, singular_RGB_trigger, numpydata, block_size)
                #        for xy in returned_edges:
                #            edges_lat.append(xy)
                            
                        # clean lists for reset
                        #pending_edges = []
                        #pending_r_signs = []
                        #pending_g_signs = []
                        #pending_b_signs = []
